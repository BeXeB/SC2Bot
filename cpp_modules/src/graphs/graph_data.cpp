...
int main() {
	...
	for (int seed: seeds) {
		...
		fileName = "Graph_" + std::to_string(seed) + ".gv";
		file = std::ofstream(fileName);
		...
		state->performAction(Action::buildWorker);
		state->performAction(Action::buildWorker);
		state->performAction(Action::buildMarine);
		state->performAction(Action::buildWorker);
		...
		state->performAction(Action::buildHouse);
		state->performAction(Action::buildWorker);
		state->performAction(Action::buildFactory);
		state->performAction(Action::buildMarine);
		state->performAction(Action::buildVespeneCollector);
		state->performAction(Action::buildWorker);
		state->performAction(Action::buildWorker);
		state->performAction(Action::buildStarPort);
		state->performAction(Action::buildMarine);
		state->performAction(Action::buildTank);
		state->performAction(Action::buildWorker);
		state->performAction(Action::buildWorker);
		state->performAction(Action::buildMarine);
