...
class Mcts:
    ...
    def __init__(self, state: State, seed: int, rollout_depth: int, exploration: float, value_heuristic: ValueHeuristic, rollout_heuristic: RolloutHeuristic) -> Mcts: ...
    def update_root_state(self, state: State) -> None : ...
    def get_root_state(self) -> State: ...
    def get_root_node(self) -> Node: ...
    def to_string(self) -> str: ...
    def search(self, time_to_search: float) -> None: ...
    def search_rollout(self, number_of_rollouts: int) -> None: ...
...
def state_builder(minerals: int,
                  ...
                  occupied_worker_timers: list[int]) -> State : ...
